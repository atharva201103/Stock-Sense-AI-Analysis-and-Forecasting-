...
>(
  (
    ...
    const toggleSidebarOriginal = React.useCallback(() => {
    ...
    const contextValueOriginal = React.useMemo(
      () => ({
      isOpen: open,
      setIsOpen: setOpen,
      state,
      ...
      openMobile,
      setOpenMobile,
      toggleSidebar: toggleSidebarOriginal,
    }),
  [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebarOriginal],
)

    return (
      <SidebarContext.Provider value={contextValueOriginal}>
...
export function SidebarTrigger({ className, asChild = false, ...props }: SidebarTriggerProps) {
  ...
  return <Comp className={cn("", className)} onClick={toggleSidebar} {...props} />
}
...
export {
  ...
  SidebarRail,
  SidebarSeparator,
  SidebarMenuButtonOriginal as SidebarMenuButton
}
